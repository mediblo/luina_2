...
class HelpCog(commands.Cog):
    def __init__(self, bot):
        ...
        self.HELP_DATA = {
            ...
            "가사": {
                "usage": "/가사 노래:Butter 가수:BTS",
                "desc": "노래 가사를 검색합니다."
            },
            "전적": {
                "usage": "/전적 닉네임:Hide on bush#KR1 모드:솔랭",
                "desc": "최근 10게임 전적을 조회합니다."
            },
            "롤": {
                "usage": "/롤 닉네임:Hide on bush#KR1",
                "desc": "소환사 정보를 조회합니다."
            },
            "롤챔프": {
                "usage": "/롤챔프 챔피언:아리",
            ...
            "로아_캐릭터": {
                "usage": "/로아_캐릭터 닉네임:메루미나",
                "desc": "로스트아크 캐릭터 정보를 요약하여 확인합니다."
            },
            "메이플_이벤트": {
                "usage": "/메이플_이벤트",
                "desc": "메이플스토리 이벤트 정보를 요약하여 확인합니다."
            },
            "메이플_공지": {
                "usage": "/메이플_공지",
                "desc": "메이플스토리 공지 정보를 요약하여 확인합니다."
            },
            "메이플_캐릭터": {
                "usage": "/메이플_캐릭터 닉네임:타락파워전사",
                "desc": "메이플스토리 캐릭터 정보를 요약하여 확인합니다."
            }
